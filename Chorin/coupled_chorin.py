...
CH_solver.parameters["newton_solver"]["relative_tolerance"] = 1e-5

NS_problem = NonlinearVariationalProblem(F_NS, w, bcs, J=J_NS) 
NS_solver = NonlinearVariationalSolver(NS_problem) 
NS_solver.parameters["newton_solver"]["linear_solver"] = "lu"
# NS_solver.parameters["newton_solver"]["preconditioner"] = "hypre_amg"
NS_solver.parameters["newton_solver"]["relative_tolerance"] = 1e-5
